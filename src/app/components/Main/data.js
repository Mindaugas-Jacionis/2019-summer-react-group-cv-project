  ...
  contacts: {
    ...
    content: [
      ...
      [
        ...
        { tag: 'a', children: '+453352453839', href: 'tel:+453352453839' },
      ],
      [
        { tag: 'label', children: 'Email' },
        {
          tag: 'a',
          children: 'test@dummy.com',
...
const jp = {
  profile: {
    title: '私について',
    text:
      '記ウワ作葉ぶのす粉知ひとじ間目てと売発げ資港クメチ引意3野ざイ汚圧か毎断ツ国産レトぎ戦南ワア弘来ケユヲノ身32屋さ論油月フヌユ失風堪だっ。碑ゆゅ内天うね本仰ぴ事問幕にな互2投んンか神療3禁イ暮義さ恐続止ふ口著ヱロ員営ニミ発4甲あるゆま助参ロホト投海ケコモ海拒ホノウ話免をげドト。',
  },
  contacts: {
    title: '連絡先',
    content: [
  ...
  experience: {
    ...
    content: [
      [
        { tag: 'p', children: 'UAB Twitter • 2019.01 - プレゼント' },
        { tag: 'p', children: 'フロントエンド ロックスター' },
      ],
      [
        { tag: 'p', children: 'Uber Eats • 2017.01 - 2019.01' },
        { tag: 'p', children: 'Eating mySQL DBs' },
